/*
Exemplo de estrutura de repetição while(condição), que primeiro testa a condição e depois executa
*/
...
do {
    console.log(`Número ${i}`) //Apresenta na tela o valor de i enquanto a condição abaixo for verdadeira
    i++ // É o mesmo que i = i + 1
